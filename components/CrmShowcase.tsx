            ...
            {CRM.modules.map((m, i) => (
              ...
              >
                <TiltCard className="h-full">
                  <article className="ring-grad flex h-full flex-col rounded-[18px] border border-line bg-gradient-to-b from-surface to-bg p-7 transition-shadow duration-300 hover:shadow-[0_24px_50px_-24px_rgba(168,64,26,0.4)]">

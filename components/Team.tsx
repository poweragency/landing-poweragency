  ...
  return (
    ...
    >
      <TiltCard className="h-full">
        <article className="ring-grad h-full rounded-[18px] border border-line bg-surface p-10 text-center transition-shadow duration-300 hover:shadow-[0_24px_50px_-28px_rgba(202,111,42,0.5)]">
